...
public class ValidateServletForJsp extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        EmployeeData employeeData = new EmployeeData(name,surname,email,pass,bod);


        FileOutputStream fos = new FileOutputStream("/home/employee/documents/foo.xml");
        XMLEncoder xenc = new XMLEncoder(fos);
        xenc.writeObject(employeeData);
        fos.close();
